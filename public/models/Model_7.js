...
function pushQuatKeyframe(xRad, yRad, zRad, arr) {
 ...
 */
function createClawProngGeometry(isUpper) {
 ...
 */
function createConnectingCylinder(pA, pB, radiusTop, radiusBottom, segments = 24) {
...
// =============================================================================
export function createRobotCharacterModel(options = {}) {
    ...
    // ---------------------------------------------------------------------------
    function createRiggedMesh(geo, material, boneIndex, name) {
        const count = geo.attributes.position.count;
        const skinIndices = new Array(count * 4);
        const skinWeights = new Array(count * 4);
...
// =============================================================================
export function createRobotCharacterLookDevLights(preset = 'studio_warm') {
...
// METRICS INSPECTOR
// =============================================================================
export function inspectModelMetrics(root) {
    let triangles = 0;
    let vertices = 0;
    let meshes = 0;
...
// =============================================================================
export function exportRiggedModelToGlb(rootGroup, filename = 'cute_3d_robot_character_rigged.glb') {
