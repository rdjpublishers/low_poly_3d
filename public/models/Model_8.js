...
function createMaterial(color, roughness = 0.65, metalness = 0.05, flatShading = true) {
...
// -----------------------------------------------------------------------------
export function createRabbitWarriorModel(options = {}) {
    ...
    function registerPivot(name, group) {
        group.name = name;
    ...
    root.userData.tick = (dt, _elapsed) => {
...
// -----------------------------------------------------------------------------
export function createRabbitWarriorModelLookDevLights(mode = 'reference') {
